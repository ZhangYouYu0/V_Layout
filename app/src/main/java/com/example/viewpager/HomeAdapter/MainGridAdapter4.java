...
public class MainGridAdapter4 extends DelegateAdapter.Adapter {
    GridLayoutHelper gridLayoutHelper;
    ArrayList<FooHomeBean.DataDTO.CategoryListDTO.GoodsListDTO> list;
    Context context;

    public MainGridAdapter4(GridLayoutHelper gridLayoutHelper, ArrayList<FooHomeBean.DataDTO.CategoryListDTO.GoodsListDTO> list, Context context) {
